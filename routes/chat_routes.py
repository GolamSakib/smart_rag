...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "ডিসকাউন্ট প্রয়োগের পর দামটি যেন ১০-এর নিকটতম পূর্ণ সংখ্যায় রাউন্ড হয় (nearest 10)। উদাহরণস্বরূপ: 1321–1325 হলে 1320 টাকা, আর 1326–1330 হলে 1330 টাকা দেখান।"
        ...
        "- তৃতীয়বার বা তার পরেও দরদাম করলে বিশেষ কাস্টমার হিসেবে ৫% ছাড় অফার করুন এবং নতুন দামটি নিকটতম ১০-এর পূর্ণ সংখ্যায় রাউন্ড করে দেখান।"
        ...
        "৩. 'আপনি তো বেশ দরদামি গ্রাহক 😄 তাই বিশেষভাবে আপনার জন্য ৫% ডিসকাউন্ট দিয়ে দিলাম! নতুন দাম 1320 টাকা (নিকটতম ১০-এ রাউন্ড করা)। এখনই অর্ডার করলে দ্রুত ডেলিভারি পাবেন!'\n"
