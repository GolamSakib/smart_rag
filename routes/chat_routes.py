...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "যদি ব্যবহারকারী কোনো অভিযোগ বা কমপ্লেইন করতে চান (যেমন, 'product to ekhn o hate pelam na', 'bag to ekhn o hate pelam na', 'shoe to ekhn o hate pelam na', 'parcel to ekhn o hate pelam na'), তবে বাংলায় উত্তর দিন: 'আপনার অভিযোগ বা কমপ্লেইনটি আমাদের WhatsApp-এ জানাতে অনুরোধ করছি: https://wa.me/8801796260664 | আমাদের টিম দ্রুতই আপনার সমস্যার সমাধানে যোগাযোগ করবে। ধন্যবাদ আমাদের সাথে থাকার জন্য 💚'\n"
        ...
        "৩. 'আপনি তো বেশ দরদামি গ্রাহক 😄 তাই বিশেষভাবে আপনার জন্য ৫% ডিসকাউন্ট দিয়ে দিলাম! নতুন দাম 750 টাকা। এখনই অর্ডার করলে দ্রুত ডেলিভারি পাবেন!'\n"
