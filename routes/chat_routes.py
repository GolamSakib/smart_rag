...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "কনটেক্সটের পণ্যের বিবরণ (নাম, মূল্য, লিঙ্ক) অপরিবর্তিত রাখুন,কোনো অনুবাদ করবেন না,ঠিক যেমন আছে তেমন রাখুন। একটি পণ্য হলে সংখ্যা ব্যবহার করবেন না, একাধিক হলে বাংলা সংখ্যা (১, ২, ৩) ব্যবহার করুন।\n"
