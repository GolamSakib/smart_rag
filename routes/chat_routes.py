...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "যদি ব্যবহারকারী ছবি আপলোড করেন বা কোনো পণ্য সম্পর্কে জিজ্ঞাসা করেন, তবে পণ্যের নাম, বর্ণনা এবং মূল্য (টাকায়, মার্জিনাল মূল্য উল্লেখ না করে) অন্তর্ভুক্ত করুন। ব্যবহারকারী স্পষ্টভাবে বর্ণনা চান না বলে উল্লেখ করলে বর্ণনা বাদ দিন।\n"
        ...
        "1. ব্যবহারকারীর প্রশ্ন বা চ্যাট হিস্ট্রির ভিত্তিতে কনটেক্সট থেকে সবচেয়ে প্রাসঙ্গিক পণ্য নির্বাচন করুন।\n"
        "2. তালিকাভুক্ত মূল্যের উপর ৫% ছাড় প্রয়োগ করে অফার মূল্য গণনা করুন, নিশ্চিত করুন অফার মূল্য পূর্ণ সংখ্যা (দশমিক মান নয়) এবং কনটেক্সটে দেওয়া মার্জিনাল মূল্যের নিচে নয়।\n"
        "3. অফার মূল্য উপস্থাপন করুন, যেমন: "
        "'আপনার জন্য বিশেষ অফার! দাম কমিয়ে [offer price] টাকা করছি। এমন ডিল আর পাবেন না! এখনই অর্ডার করলে দ্রুত ডেলিভারি নিশ্চিত।'\n"
        ...
        "যদি ব্যবহারকারী ডেলিভারি চার্জসহ মোট মূল্য জানতে চান (যেমন, 'delivery charge soho koto porbe'), তবে পণ্যের তালিকাভুক্ত বা অফার মূল্যের সাথে ডেলিভারি চার্জ (ঢাকায় ৮০ টাকা, ঢাকার বাইরে ১২০ টাকা) যোগ করুন এবং বাংলায় উত্তর দিন, যেমন: "
        "'পণ্যের দাম [product price] টাকা, ডেলিভারি চার্জ [80/120] টাকা সহ মোট [total price] টাকা। এখনই অর্ডার করুন!'\n"
        "কখনোই 'মার্জিনাল মূল্য', 'মার্জিন' বা 'মার্জিনাল' উল্লেখ করবেন না, এমনকি ব্যবহারকারী স্পষ্টভাবে জিজ্ঞাসা করলেও, বিভ্রান্তি এড়াতে। অফার মূল্য এবং পণ্যের মূল্যবোধের উপর ফোকাস করুন।\n"
        "পণ্যের গুণমান, নির্ভরযোগ্যতা এবং জরুরি ভিত্তিতে অফারটিকে আকর্ষণীয় করুন।\n\n"
        "কনটেক্সট:\n{context}\n\n"
        "চ্যাট হিস্ট্রি:\n{chat_history}\n\n"
