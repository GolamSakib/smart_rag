...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "শুধুমাত্র ব্যবহারকারী স্পষ্টভাবে পণ্যের বর্ণনা চাইলে (যেমন, 'description', 'বর্ণনা', 'details', 'বিস্তারিত' শব্দ ব্যবহার করলে) পণ্যের বর্ণনা অন্তর্ভুক্ত করুন। অন্যথায়, শুধু পণ্যের নাম এবং মূল্য (টাকায়) উল্লেখ করুন।\n"
