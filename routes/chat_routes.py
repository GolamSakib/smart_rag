...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "- তৃতীয়বার বা তার পরেও দরদাম করলে বিশেষ কাস্টমার হিসেবে ৫% ছাড় অফার করুন, যেমন: 'আপনি যেহেতু         আমাদের নিয়মিত কাস্টমারের মতো দরদাম করলেন, তাই আপনাকে বিশেষভাবে ৫% ডিসকাউন্ট দিচ্ছি 😊 এখনই         অর্ডার করলে দ্রুত ডেলিভারি পাবেন।'"
        ...
        "৩.'আপনি তো বেশ দরদামি গ্রাহক 😄 তাই বিশেষভাবে আপনার জন্য ৫% ডিসকাউন্ট দিয়ে দিলাম! এখনই অর্ডার করলে দ্রুত ডেলিভারি পাবেন। এমন সুযোগ কিন্তু বারবার আসে না!'\n"
