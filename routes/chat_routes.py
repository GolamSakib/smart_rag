...
prompt = PromptTemplate(
    ...
    template=(
        ...
        "যদি ব্যবহারকারী ছবি আপলোড করেন বা কোনো পণ্য সম্পর্কে জিজ্ঞাসা করেন, তবে পণ্যের নাম, বর্ণনা এবং মূল্য (টাকায়) অন্তর্ভুক্ত করুন। ব্যবহারকারী স্পষ্টভাবে বর্ণনা চান না বলে উল্লেখ করলে বর্ণনা বাদ দিন।\n"
